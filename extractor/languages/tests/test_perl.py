...
class perlTest(unittest.TestCase):
    ...
    def test_output(self):
        ...
        self.syntax_end = "=cut"
        sign = '#'
        comment_single = perl.readSingleLine(path,regex,sign)
        comment_multiline = perl.readMultiLineDiff(path,self.syntax_start,self.syntax_end)
    ...
    def test_outputFormat(self):
        ...
        self.syntax_end = "=cut"
        sign = '#'
        expected = perl.perlExtractor(path)
    ...
    def test_Source(self):
        path = os.path.join(os.getcwd(),"languages/tests/TestFiles/textcomment.pl")
        name = "source.txt"
        newfile = perl.perlSource(path,name)
